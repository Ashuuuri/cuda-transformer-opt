...
COLORS = {
    "INT8 Fused Kernel":         "#1B3A5C",   # deep navy
    "FP16 Fused Kernel":         "#3D7EA6",   # ocean blue
    "Naive PyTorch":             "#C0C0C0",   # silver
    "FlashAttn-2":               "#5BA08C",   # teal green
    "cuBLAS GEMMs":              "#8AA4BF",   # slate blue
}
MARKERS = {
    "INT8 Fused Kernel":         "o",
    "FP16 Fused Kernel":         "s",
